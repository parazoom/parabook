class JumpType {
  ...
  factory JumpType.fromMap(Map<String, dynamic> m) => JumpType(
        id: m['id'],
        name: m['name'],
  ...
  JumpType copyWith({int? id, String? name, bool? isDefault, bool? isArchived, int? jumpsBefore, String? notes}) =>
      JumpType(
        id: id ?? this.id,
        name: name ?? this.name,
